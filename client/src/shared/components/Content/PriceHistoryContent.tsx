// src/components/common/PriceHistoryContent.tsx
...
interface PriceHistoryContentProps {
  ...
  onSelectIdealAuctionPrice?: (price: any) => void;
}
    ...
    try {
      ...
      const sorted = Object.entries(byV)
        ...
        .map(([v, arr]: [string, any[]]) => [
          v,
          (arr as any[]).sort((p: any, q: any) => new Date(q.WPR_datetime).getTime() - new Date(p.WPR_datetime).getTime()),
        ] as [string, any[]]);
