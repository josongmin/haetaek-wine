...
// 개발 환경에서는 로컬 서버 사용, 프로덕션에서는 프로덕션 서버 사용
 ...
 */
export const createWinePrice = async (payloadObj: Record<string, any>) => {
 ...
 */
export const updateWinePrice = async (payloadObj: Record<string, any>) => {
...
export const mergeWine = async (wineIndexFrom: string | number, wineIndexTo: string | number, user: any) => {
  const params = new URLSearchParams();
  params.append('wineIndexFrom', String(wineIndexFrom));
  params.append('wineIndexTo', String(wineIndexTo));
...
export const searchWines = async (user: any, cleanedSearchText: string, loadRowCount: number = 40) => {
  try {
    const params = new URLSearchParams();
    params.append('requesterIndex', String(user.index));
    params.append('accessToken', String(user.accessToken));
    params.append('searchText', cleanedSearchText);
    params.append('loadRowCount', String(loadRowCount));
...
export const loadRegionOptions = async (inputValue: string, grapes: string | null = null) => {
  const params = new URLSearchParams();
...
export const addWine = async (formData: any, user: any) => {
...
export const updateWine = async (index: string | number, wineData: any, user: any) => {
  const params = new URLSearchParams();
  params.append('wineIndex', String(index));
...
export async function fetchWineByIndex(wineIndex: string | number, user: any) {
  const params = new URLSearchParams();
  params.append('wineIndex', String(wineIndex));
...
export const fetchWinePrices = async (filters: any) => {
  try {
 ...
 */
export const updatePhotoType = async (photoIndex: string | number, newType: number, accessToken: string = 'admin:1234qwer') => {
  try {
    const params = new URLSearchParams();
    params.append('photoIndex', String(photoIndex));
    params.append('status', String(newType));
...
export const updateWinePriceStatus = async (status: number, winePriceIndex: string | number, point: number) => {
...
export const updateWinePriceWriter = async (winePriceIndex: string | number, writerIndex: string | number) => {
...
export const insertPointForWritePrice = async (userIndex: string | number, itemIndex: string | number, point: number, reason: string) => {
  try {
...
export const updatePointForWritePrice = async (userIndex: string | number, index: string | number, point: number, reason: string) => {
  try {
...
export const deletePointHistoryWithSyncUserPoint = async (userIndex: string | number, index: string | number) => {
  try {
...
export const insertReportForPrice = async (reporterIndex: string | number, winePriceIndex: string | number, reason: string) => {
  try {
...
export const updateReportForPrice = async (reportIndex: string | number, reason: string) => {
  try {
...
export const deleteReportForPrice = async (reportIndex: string | number) => {
  try {
...
export const setShowInSpecialPricePage = async (show: boolean, winePriceIndex: string | number) => {
  try {
...
export const setShowInWineDetailPage = async (show: boolean, winePriceIndex: string | number) => {
  try {
...
export const setStockCountOfPrice = async (stockCount: number, winePriceIndex: string | number) => {
  try {
...
export const setNeededPointForShowOfPrice = async (point: number, winePriceIndex: string | number) => {
  try {
...
export const setHasReceiptOfPrice = async (hasReceipt: boolean, winePriceIndex: string | number) => {
  try {
...
export const updateUserLevel = async (userIndex: string | number, level: number) => {
  try {
...
export const deletePriceWithRelatedData = async (priceIndex: string | number, wineIndex: string | number) => {
  try {
...
export const getWineShopList = async (searchText: string) => {
  try {
...
export const getUsedDiscountHistoryListOfShop = async (shopIndex: string | number) => {
  try {
...
export const getHotDealCountOfUser = async (userIndex: string | number, days: number | null) => {
  try {
...
export const getCommentHistoryListOfShop = async (shopIndex: string | number) => {
  try {
 ...
 */
export const crawlWinePrices = async (wineName: string) => {
  try {
...
export async function sendPushToToken({ token, title, body, data }: { token: string; title: string; body: string; data: any }) {
  try {
...
export async function sendPushToUsers({ userIds, title, body, data }: { userIds: string[]; title: string; body: string; data: any }) {
  try {
...
export async function sendPushToTopic({ topic, title, body, data }: { topic: string; title: string; body: string; data: any }) {
  try {
...
export async function pushUserLevelChanged({ token, userIndex, level }: { token: string; userIndex: string | number; level: number }) {
...
export async function pushPriceReview({ token, userIndex, priceIndex, title, message }: { token: string; userIndex: string | number; priceIndex: string | number; title: string; message: string }) {
  const data = {
    notificationType: "1",
...
export const getUserByIndex = async (userIndex: string | number) => {
  try {
...
export const updateWineStatus = async (wineIndex: string | number, status: number) => {
...
export const updateWineStatusToIncompleteIfNotPass = async (wineIndex: string | number) => {
...
export const keywordSuggestion = async (keyword: string) => {
  try {
...
export const deleteSearchCache = async (keyword: string) => {
  try {
...
export const getWineDetails = async (wine: any) => {
  try {
 ...
 */
export const aiSuggestionFulltext = async (text: string) => {
  try {
    // 개발 환경에서는 로컬 서버 사용
    ...
    const url = `${baseUrl}/ai/suggestion_fulltext`;
    const requestData = { text: text.trim() };
    
    console.log('[AI Suggestion] 요청 시작:', {
      url,
    ...
    console.log('[AI Suggestion] 응답 받음:', {
      status: response.status,
      data: response.data,
      winesCount: response.data?.wines?.length || 0
    });
 ...
 */
export const searchCandidatesWithPerplexity = async (candidates: any[], originalKo: string) => {
  try {
 ...
 */
export const searchCandidatesWithPerplexityV2 = async (candidates: any[], originalKo: string) => {
  try {
 ...
 */
export const searchSingleCandidate = async (candidate: string, originalKo: string) => {
  try {
 ...
 */
export const searchSingleCandidateV3 = async (candidate: string, originalKo: string, searchMetadata: any = null) => {
  try {
