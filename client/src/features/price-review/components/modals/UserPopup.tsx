// src/components/reviewPrice/UserPopup.tsx
...
interface UserPopupProps {
  item: any;
  onClose: () => void;
  onViewPrices?: (userIndex: string | number) => void;
}
...
export default function UserPopup({
  ...
  // "특가 등록 이력"용 state
  const [hotCountLast3, setHotCountLast3] = useState<number | null>(null);
  const [hotCountAll, setHotCountAll] = useState<number | null>(null);
  const [loadingHot, setLoadingHot] = useState<boolean>(false);
