...
interface PriceFilterFormProps {
  ...
  initialFilters: any;
  aiSearchText?: string;
  onAiSearchTextProcessed?: () => void;
}

export default function PriceFilterForm({ onSubmit, isLoading, initialFilters, aiSearchText, onAiSearchTextProcessed }: PriceFilterFormProps) {
