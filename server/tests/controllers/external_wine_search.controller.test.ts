...
describe('External Wine Search Controller', () => {
  ...
  describe('keywordSuggestion', () => {
    test('성공 - 한글 키워드로 와인 제안 받기', async () => {
      ...
      mockedFetch.mockResolvedValueOnce(mockGeminiResponse as any);

      await externalWineSearchController.keywordSuggestion(req as Request, res as Response);
    ...
    test('실패 - Gemini API 오류', async () => {
      ...
      mockedFetch.mockResolvedValueOnce(mockError as any);
  ...
  describe('getWineDetails', () => {
    test('성공 - 와인 상세 정보 조회', async () => {
      ...
      mockedFetch.mockResolvedValueOnce(mockPerplexityResponse as any);

      await externalWineSearchController.getWineDetails(req as Request, res as Response);
  ...
  describe('deleteCache', () => {
    test('성공 - 캐시 삭제', async () => {
      ...
      await externalWineSearchController.deleteCache(req as Request, res as Response);
  ...
  describe('searchCandidatesWithPerplexity', () => {
    test('성공 - 후보 검색', async () => {
      ...
      await externalWineSearchController.searchCandidatesWithPerplexity(req as Request, res as Response);
