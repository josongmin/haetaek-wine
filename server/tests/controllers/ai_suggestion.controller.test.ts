...
describe('AI Suggestion Controller', () => {
  ...
  describe('suggestionFulltext', () => {
    test('성공 - 유효한 입력으로 와인 제안 받기', async () => {
      ...
      mockedFetch
        ...
        .mockResolvedValueOnce(mockGeminiResponse as any);

      await aiSuggestionController.suggestionFulltext(req as Request, res as Response);
    ...
    test('실패 - OpenAI API 오류', async () => {
      ...
      mockedFetch
        .mockResolvedValueOnce(mockOpenAIError as any)
        .mockResolvedValueOnce(mockGeminiResponse as any);
    ...
    test('실패 - Gemini API 오류', async () => {
      ...
      mockedFetch
        .mockResolvedValueOnce(mockOpenAIResponse as any)
        .mockResolvedValueOnce(mockGeminiError as any);
  ...
  describe('analyzeWineResults', () => {
    test('성공 - 와인 결과 분석', async () => {
      ...
      mockedFetch.mockResolvedValueOnce(mockOpenAIResponse as any);

      await aiSuggestionController.analyzeWineResults(req as Request, res as Response);
